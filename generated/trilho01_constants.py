...
# Configuração de cada Step do Trilho 01
TRILHO01_STEP_CONFIGS: dict[str, StepConfig] = {
...
# Rubricas de Avaliação do Trilho 01
TRILHO01_INTERNAL_RUBRICS: dict[str, RubricCriteria] = {
...
# Materiais Disponíveis do Trilho 01
TRILHO01_AVAILABLE_MATERIALS: list[str] = [
    "video02.md",
...
# Steps apenas conteúdo (sem pergunta) do Trilho 01
TRILHO01_CONTENT_ONLY_STEPS: list[str] = [
    "t01_s2_video01",
    "t01_s3_texto_abertura",
    "t01_s5_competencias",
    "t01_s6_texto_articulacao",
